        ...
        <section className="mt-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-xl bg-white shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">Connect with industry professionals and alumni who guide your career journey</p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl bg-white shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">Book sessions that fit your schedule with our intelligent matching system</p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl bg-white shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">Monitor your growth with detailed analytics and milestone achievements</p>
            </div>
          </div>
        </section>
      </main>
